...
public class Branch {
    ...
    public boolean addCustomerTranscation(String customerName, double transaction) {
        Customer customer = findCustomer(customerName.toUpperCase());
    ...
    public Customer findCustomer(String customerName) {
        for (Customer customer : customers) {
            if (customer.getName() == customerName.toUpperCase()) {
                return customer;
            }
        }
        return null;
